...
import { JournalPreviewService, type JournalPreviewResult, type PreviewEntry } from "./journal-preview.facade";
            ...
            saved.push(
              await tx.asientoContable.create({
                data: {
                  ...
                  periodoContableId: preview.periodo.id,
                  ...
                  hojaOrigen: entry.hojaOrigen,
                  filaOrigen: entry.filaOrigen,
                  estado: params.estado || "GENERADO",
                  lineas: {
                    create: entry.lineas.map((line) => ({
                      cuentaContableId: line.cuentaId,
